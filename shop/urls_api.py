...
urlpatterns = [
    ...
    path('api/v1/category_attributes', AttributeValuesAPIList.as_view()),
    path('api/v1/category_attributes_create', AttributeValuesAPICreate.as_view()),
    path('api/v1/category_attributes/<int:pk>', AttributeValuesAPIRetrieve.as_view()),
    path('api/v1/category_attributes_update/<int:pk>', AttributeValuesAPIUpdate.as_view()),
    path('api/v1/category_attributes_delete/<int:pk>', AttributeValuesAPIDelete.as_view()),
    path('api/v1/product_attributes', AttributeProductValuesAPIList.as_view()),
    path('api/v1/product_attributes_create', AttributeProductValuesAPICreate.as_view()),
    path('api/v1/product_attributes/<int:pk>', AttributeProductValuesAPIRetrieve.as_view()),
    path('api/v1/product_attributes_update/<int:pk>', AttributeProductValuesAPIUpdate.as_view()),
    path('api/v1/product_attributes_delete/<int:pk>', AttributeProductValuesAPIDelete.as_view()),
