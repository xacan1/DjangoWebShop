...
urlpatterns = [
    ...
    path('api/v1/attribute_values', AttributeValuesAPIList.as_view()),
    path('api/v1/attribute_values_create', AttributeValuesAPICreate.as_view()),
    path('api/v1/attribute_values/<int:pk>', AttributeValuesAPIRetrieve.as_view()),
    path('api/v1/attribute_values_update/<int:pk>', AttributeValuesAPIUpdate.as_view()),
    path('api/v1/attribute_values_delete/<int:pk>', AttributeValuesAPIDelete.as_view()),
    path('api/v1/attribute_product_values', AttributeProductValuesAPIList.as_view()),
    path('api/v1/attribute_product_values_create', AttributeProductValuesAPICreate.as_view()),
    path('api/v1/attribute_product_values/<int:pk>', AttributeProductValuesAPIRetrieve.as_view()),
    path('api/v1/attribute_product_values_update/<int:pk>', AttributeProductValuesAPIUpdate.as_view()),
    path('api/v1/attribute_product_values_delete/<int:pk>', AttributeProductValuesAPIDelete.as_view()),
